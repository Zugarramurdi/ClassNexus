  ...
  void _confirmDelete(BuildContext context, WidgetRef ref, String id, String name) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('¿Estás seguro de que quieres eliminar al profesor $name?'),
        actions: [
          TextButton(
            ...
            onPressed: () async {
              ...
              if (context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('Profesor $name eliminado')),
                );
              }
            },
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () => Navigator.of(context).push(
                    MaterialPageRoute(builder: (_) => UserFormPage(roleId: 2, user: row['original']))
                  ),
                ),
                IconButton(
